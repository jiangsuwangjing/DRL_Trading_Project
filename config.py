...
DOW30_TICKERS = [
    ...
    'BA', 'CVX', 'HON', 'IBM', 'JNJ', 'JPM', 'PG', 
    'CSCO', 'DIS', 'INTC', 'MRK', 'VZ', 'WMT', 'KO', 'MMM', 'PFE',
    'XOM', 'DD', 'UTX', 'GE'  # These were in DOW30 in 2012
]
# Date ranges
...
MAX_MFI = 100.0  # Normalization factor for Money Flow Index (0-100)
MAX_PE = 100.0  # Normalization factor for P/E ratio (clip/divide by this)
MAX_OBV = 1e8  # Normalization factor for On-Balance Volume (scale depending on dataset)
